...
# Length of each is how many meeple spots there is 
MEEPLE_LOC_DICT={
    0:{("C",0):(0,1)},
    1:{("C",0):(0,1),("G",0):(3,1)},
    2:{("C",0):(0,1),("G",0):(3,1)},
...
# Tile index, Meeple Location placed, rotation 

# Features that are connected on each tile 
feature_coord = {
...
features_specific={
    ...
    1: {0: ['C'], 1: ['C'], 2: ['C'], 3:['G']},
    2: {0: ['C'], 1: ['C'], 2: ['C'], 3:['G']},
    3: {0: ['C'], 1: ['C'], 2: ['C'], 3:['G', 'R', 'G']},
    4: {0: ['C'], 1: ['C'], 2: ['C'], 3:['G', 'R', 'G']},
    5: {0: ['G'], 1: ['C'], 2: ['C'], 3:['G']},
    6: {0: ['G'], 1: ['C'], 2: ['C'], 3:['G']},
    7: {0: ['G'], 1: ['C'], 2: ['C'], 3:['G']},
    8: {0: ['G', 'R', 'G'], 1: ['C'], 2: ['C'], 3:['G', 'R', 'G']},
    9: {0: ['G', 'R', 'G'], 1: ['C'], 2: ['C'], 3:['G', 'R', 'G']},
    10: {0: ['C'], 1: ['G'], 2: ['C'], 3:['G']},
    11: {0: ['G'], 1: ['C'], 2: ['G'], 3:['C']},
    12: {0: ['C'], 1: ['G'], 2: ['C'], 3:['G']},
    13: {0: ['G'], 1: ['C'], 2: ['G'], 3:['G']},
    14: {0: ['G', 'R', 'G'], 1: ['C'], 2: ['G'], 3:['G', 'R', 'G']},
    15: {0: ['F'], 1: ['F', 'Monastery'], 2: ['F'], 3:['G', 'R', 'G']},
    16: {0: ['G', 'R', 'G'], 1: ['C'], 2: ['G', 'R', 'G'], 3:['G']},
    17: {0: ['G'], 1: ['C'], 2: ['G', 'R', 'G'], 3:['G', 'R', 'G']},
    18: {0: ['G', 'R', 'G'], 1: ['C'], 2: ['G', 'R', 'G'], 3:['G', 'R', 'G']},
    19: {0: ['G', 'R', 'G'], 1: ['G'], 2: ['G', 'R', 'G'], 3:['G', 'R', 'G']},
    20: {0: ['G'], 1: ['G', 'Monastery'], 2: ['G'], 3:['G']},
    21: {0: ['G', 'R', 'G'], 1: ['G'], 2: ['G'], 3:['G', 'R', 'G']},
    22: {0: ['G', 'R', 'G'], 1: ['G'], 2: ['G', 'R', 'G'], 3:['G']},
    23: {0: ['G', 'R', 'G'], 1: ['G', 'R', 'G'], 2: ['G', 'R', 'G'], 3:['G', 'R', 'G']}
